...
class Datum {
  ...
  factory Datum.fromJson(Map<String, dynamic> json) => Datum(
        ...
        workday:
            List<Workday>.from(json["workday"].map((x) => Workday.fromJson(x))),
...
class Education {
  ...
  factory Education.fromJson(Map<String, dynamic> json) => Education(
        ...
        doctorUniversity:
            doctorUniversityValues.map[json["doctor_university"]]!,
        doctorStudyProgram:
            doctorStudyProgramValues.map[json["doctor_study_program"]]!,
...
enum DoctorUniversity { UNIVERSITY_C, UNIVERSITY_D }
...
class Experience {
  ...
  factory Experience.fromJson(Map<String, dynamic> json) => Experience(
        ...
        doctorCompanyAddress:
            doctorCompanyValues.map[json["doctor_company_address"]]!,
...
enum DoctorTitle { TITLE_C, TITLE_D }

final doctorTitleValues = EnumValues(
    {"Title C": DoctorTitle.TITLE_C, "Title D": DoctorTitle.TITLE_D});
